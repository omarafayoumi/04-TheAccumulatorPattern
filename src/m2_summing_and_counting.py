...
def run_test_sum_more_cosines():
    ...
    if answer is not None:
        ...
        print('       actual:  ', answer)
    # Test 3:
    expected = 0.987  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(10, 33)
...
def run_test_count_sines_from():
    ...
    # Test 2:
    expected = 134
    answer = count_sines_from(1, 200)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    # Test 3:
    expected = 1
    answer = count_sines_from(20, 22)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    # Test 4:
    expected = 5
    answer = count_sines_from(13, 20)
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 2:
    expected = 12347
    answer = count_sines_vs_cosines(12345)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    # Test 3:
    expected = 20
    ...
    # Test 5:
    expected = 53
    answer = count_sines_vs_cosines(53)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
    # Test 6:
    expected = 1
